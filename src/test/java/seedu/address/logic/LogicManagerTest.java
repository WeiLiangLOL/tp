...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        UniqueFoodListStorage uniqueFoodListStorage = new JsonUniqueFoodListStorage(temporaryFolder.resolve("foodList.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonUniqueFoodListStorage uniqueFoodListStorage =
                new JsonUniqueFoodListStorage(temporaryFolder.resolve("ioExceptionUniqueFoodList.json"));
        StorageManager storage = new StorageManager(addressBookStorage, uniqueFoodListStorage, userPrefsStorage);
        logic = new LogicManager(model, storage);
